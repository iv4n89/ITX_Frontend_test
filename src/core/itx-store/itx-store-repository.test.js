...
describe('ItxStoreRepository', () => {
    ...
    describe('getProductList', () => {
        ...
        it('should handle errors when fetching product list', async () => {
            ...
            await expect(ItxStoreRepository.getProductList()).rejects.toThrow('Network error');
            expect(consoleErrorSpy).toHaveBeenCalledWith('Error fetching product list:', mockError);
